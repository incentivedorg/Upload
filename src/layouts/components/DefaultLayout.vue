    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          ...
          <h1 class="flex-1 ml-3 text-base font-semibold dark:text-white">
            INCENTIVED.ORG
          </h1>
        </RouterLink>
        <div
      ...
      <div class="px-2">
        ...
        <a
          href="https://twitter.com/incentivedorg"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
        ...
        >
          ...
          >
            Telegram
                ...
                <a
          href="mailto:mailincentived@gmail.com"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
         ...
         <a
          href="https://github.com/incentivedorg"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
          <Icon icon="mdi:telegram" class="text-xl mr-2" />
