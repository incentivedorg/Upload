...
export declare class BannerAd extends BannerAdHelper {
    ...
    constructor(adEventServerController: AdEventServerController, adServerController: AdServerController, placementId: string, containerId: string, adConfig: BannerAdConfig, environment: ENVIRONMENT, cb?: (error: string) => void);
    private _fetchAd;
    private _renderAd;
